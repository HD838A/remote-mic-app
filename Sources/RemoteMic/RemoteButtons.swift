...
enum ButtonAction: String, CaseIterable, Codable, Identifiable {
    ...
    func displayName(using localization: LocalizationStore) -> String {
        ...
        case .showQuickPhrases: return localization.text("action.show_quick_phrases")
    ...
    var category: ButtonActionCategory {
        ...
        case .customShortcut, .focusInput, .showQuickPhrases, .openCustomApplication:
            return .custom
    ...
    var isAppInternal: Bool {
        self == .toggleLongRecording || self == .showQuickPhrases
    }
