...
- [Codex 切换框第 6～9 项显示占位名称](./2026-08-29-codex-project-picker-only-five-names.md)
...
| 时间 | Bug | 状态 |
| --- | --- | --- |
| 2026-08-29 | [Codex 切换框第 6～9 项显示占位名称](./2026-08-29-codex-project-picker-only-five-names.md) | 已修复；真实 9 条标题读取与单页完整显示均经用户验收通过 |
