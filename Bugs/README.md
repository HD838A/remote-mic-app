...
- [卡拉 OK 返听同时触发系统 Fn 语音识别](./2026-08-26-karaoke-voice-key-fn-leak.md)
...
| 时间 | Bug | 状态 |
| --- | --- | --- |
| 2026-08-26 | [卡拉 OK 返听同时触发系统 Fn 语音识别](./2026-08-26-karaoke-voice-key-fn-leak.md) | 候选修复完成；自动化通过，等待 RC001 / RC003、系统输入法及真实声学验收 |
