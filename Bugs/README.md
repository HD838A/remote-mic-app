...
- [自定义按键 Control 组合、原始按键泄漏与跨 Mac 切换边界](./2026-08-29-custom-key-control-native-leak-and-mac-switching.md)
...
| 时间 | Bug | 状态 |
| --- | --- | --- |
| 2026-08-29 | [自定义按键 Control 组合、原始按键泄漏与跨 Mac 切换边界](./2026-08-29-custom-key-control-native-leak-and-mac-switching.md) | 原始按键泄漏与 App 级 handoff 暂停候选完成；系统 HID 免忽略切换仍待两台 Mac + RC003 真机验证 |
