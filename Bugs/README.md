...
- [移动语音在 Typeless 模式下错误地长按 Fn](./2026-09-02-mobile-typeless-fn-hold.md)
...
| 时间 | Bug | 状态 |
| --- | --- | --- |
| 2026-09-02 | [移动语音在 Typeless 模式下错误地长按 Fn](./2026-09-02-mobile-typeless-fn-hold.md) | 候选修复完成；自动化通过，等待 iPhone、Apple Watch、Web 与 Typeless 真机验收 |
