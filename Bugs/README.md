...
- [macOS 听写仍需手动触发](./2026-09-01-macos-dictation-needs-manual-shortcut.md)
...
| 时间 | Bug | 状态 |
| --- | --- | --- |
| 2026-09-01 | [macOS 听写仍需手动触发](./2026-09-01-macos-dictation-needs-manual-shortcut.md) | 根因确认并完成候选修复；已补关键状态机用例，等待 PR CI、签名包与 RC003 真实文字验收 |
