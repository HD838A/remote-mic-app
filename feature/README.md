...
| [邀请制 AI 整理](./early-access-ai-polish/) | 候选验证中 | 通过通用 Early Access 资格控制开发中的 DeepSeek 语音结束后整理，普通用户默认不可见。 |
| [DeepSeek 语音结束后整理 MVP](./deepseek-post-dictation-mvp/) | 候选验证中 | 豆包上屏后对本次语音做克制整理，并在写回前重复验证目标和文本范围。 |
