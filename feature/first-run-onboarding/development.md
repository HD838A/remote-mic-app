...
- 2026-08-20 HID 首报告死锁候选：1.9.3 现场日志确认 157 次设备匹配均被延迟且没有报告或边沿；失败优先测试后改为非独占探测候选，只有包含已知普通按键的真实报告才提升设备，空闲报告不会抢占。Remote buttons 86 项、Onboarding 28 项、完整 Swift 316 项/31 suites、硬件事件回放 21 项、项目自检 42/42 与 Apple Silicon / Intel Release 构建通过；真实 IOHID 回调、双遥控器及电源键仍待真机验收。
