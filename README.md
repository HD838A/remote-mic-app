...
右键菜单中的“语言”可选择“跟随系统”“简体中文”或“English”。设置窗口、状态、菜单和内置帮助会立即刷新，无需重启应用；系统权限提示和第三方界面仍会在下次打开时按 macOS 自身的语言显示。

应用每天自动检查一次更新，发现新版本后由用户确认是否安装；不会静默下载或自动安装。右键菜单中的“检查更新…”仍可随时手动检查。Sparkle 仅更新应用本体，兼容麦克风驱动仍由 DMG 中的安装包管理。
