...
“连接与语音”和“按键映射”的设备卡片优先显示系统蓝牙设置中的自定义名称；同名设备从 1 开始编号，未改名设备保留原有型号编号。修改名称后，返回无线麦或重新打开相关页面即可刷新；离线设备保留上次读到的名称。当前系统名称同步覆盖小米遥控器和苹果遥控器，A2854 的独立系统 API 读取已验证，候选 App 的完整兼容性仍待验收。
