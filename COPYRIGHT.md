...
本仓库包含原生 macOS 适配版本，以及独立打包的 Windows RC003 麦克风版本。实现参考了 GPL-3.0-only 项目 [xxb26553663-star/remote-bridge-hub](https://github.com/xxb26553663-star/remote-bridge-hub)，参考提交为 `8a93f321ac71a602300c6cd77f7256fa4b63068e`；Windows 选择性移植的来源另见 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)。
...
- 独立的 Windows RC003 WinRT BLE/ATVV 麦克风桥接，以及 Windows CI、PyInstaller/Inno Setup 和免费自签发布流程。
