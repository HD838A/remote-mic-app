...
REQUIRE_SIRI_REMOTE_SIGNING="${REQUIRE_SIRI_REMOTE_SIGNING:-1}"
...
case "$REQUIRE_SIRI_REMOTE_SIGNING" in
  0|1) ;;
  *) print -u2 "REQUIRE_SIRI_REMOTE_SIGNING must be 0 or 1"; exit 1 ;;
esac
...
if [[ "$SAYALL_SIRI_REMOTE_INCLUDED" == "true" &&
