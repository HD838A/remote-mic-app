...
struct BuildSigningTests {
    ...
    @Test func previewBranchPushBuildsACandidateWithoutReleaseSecrets() throws {
        ...
        #expect(workflowSource.contains("955e7eccaf68ec463d0c8927513691000f567f2c"))
        ...
        #expect(workflowSource.contains("30f8e52658bfbdcc670d43c3637479dc221c9df8"))
        ...
        #expect(ciWorkflowSource.contains("955e7eccaf68ec463d0c8927513691000f567f2c"))
