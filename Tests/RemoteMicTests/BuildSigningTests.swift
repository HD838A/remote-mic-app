...
struct BuildSigningTests {
    ...
    @Test func previewBranchPushReusesExactParentMainProofWithoutRepeatingBuilds() throws {
        ...
        #expect(workflowSource.contains("5801ec92d937e20d1d05945a27212168298db554"))
        ...
        #expect(!workflowSource.contains("SAYALL_PRIVATE_PLATFORM_DEPLOY_KEY"))
        ...
        #expect(ciWorkflowSource.contains("GetSayAll/sayall-private-platform"))
        #expect(ciWorkflowSource.contains("5801ec92d937e20d1d05945a27212168298db554"))
        #expect(ciWorkflowSource.contains("SAYALL_PRIVATE_PLATFORM_DEPLOY_KEY"))
        #expect(ciWorkflowSource.contains("packages/macos-button-profiles"))
