...
struct BuildSigningTests {
    ...
    @Test func optimizedReleasePipelineHasExecutableRegressionCoverage() throws {
        ...
        #expect(releaseWorkflowSource.contains("TOTAL_SLO_SECONDS: 1740"))
        #expect(releaseWorkflowSource.contains("READY_SLO_SECONDS: 840"))
        #expect(releaseWorkflowSource.contains("timeout-minutes: 30"))
        #expect(releaseWorkflowSource.contains("PREVIEW_SIGNED_READY_SLO_SECONDS: 660"))
