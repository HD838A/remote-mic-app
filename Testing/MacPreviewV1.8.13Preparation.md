...
- 目标版本：`1.8.13 (105)`。
- 当前分支：`release/pre-v1.8.13`。
- 产品改动已经通过 PR #27 合入 `main`，当前候选仅增加版本号、版本历史与发布验证记录。
- 当前进入预览候选的双架构 CI、签名、公证和公开资产验证阶段。
...
- 签名、公证、Sparkle 候选源与跨版本更新将在最终公开资产生成后验证；无法自动化的真实设备流程仍按上述边界记录。
