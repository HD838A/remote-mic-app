...
3. 启动无线麦SayAll.app并进入“设置”页的“权限与隐私”区。
...
3. 启动新版本，确认 App 打开设置窗口后直接显示“设置”页并可见“权限与隐私”区，不先显示连接页，也不要求重跑完整 Onboarding。
...
预期：系统只显示当前无线麦SayAll.app条目；授权后权限区仍保留“打开系统设置”恢复入口，状态显示真实已开启。
